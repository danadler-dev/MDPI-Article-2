...
\Title{Adaptive Bayesian Assembly in Dynamic Information Evolution}

% MDPI internal command: Title for citation in the left column
\TitleCitation{Adaptive Bayesian Assembly in Dynamic Information Evolution}
